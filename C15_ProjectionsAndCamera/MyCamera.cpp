...
{
	ResetCamera();
	CalculateProjectionMatrix(1080,720);
	CalculateViewMatrix();
...
void MyCamera::CalculateProjectionMatrix(float width = 1080.0f, float height =  720.0f)
{
	//perspective
	...
	//m_m4Projection = glm::ortho(0.0f, 5.0f * fRatio, -5.0f, 5.0f, fNear, fFar);
	//fFar += 0.001f;
}
